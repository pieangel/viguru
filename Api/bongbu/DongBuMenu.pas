...
procedure TDongBuData.concernClick(Sender: TObject);
begin
...
procedure TDongBuData.DataModuleCreate(Sender: TObject);
begin
...
procedure TDongBuData.OpenWins;
var
...
procedure TDongBuData.FormOpen(iFormID, iVar: Integer; var aForm: TForm);
var
  bForm : TForm;
begin
  aForm := nil;
...
procedure TDongBuData.FormReLoad(iFormID: integer; aForm: TForm);
begin

end;

procedure TDongBuData.FormLoad(iFormID: Integer; aStorage: TStorage; var aForm: TForm);
var
  aItem : TForm;
begin
    // create/get form
...
procedure TDongBuData.FormSave(iFormID: Integer; aStorage: TStorage; aForm: TForm);
begin
    //
  if aForm = nil then Exit;
...
procedure TDongBuData.Help1Click(Sender: TObject);
var
  iTag : integer;
  aItem : TMenuItem;
  aForm : TForm;
...
procedure TDongBuData.init;
begin

end;

procedure TDongBuData.N7Click(Sender: TObject);
begin
