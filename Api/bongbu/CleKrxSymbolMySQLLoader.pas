...
///////////////////////////////////////////////////////////////////////////////////
    ...
    gEnv.ErrString  := '선물옵션 종목마스터 파싱 에러';
    gEnv.OnState( asError );
    gLog.Add( lkError, 'TKRXSymbolMySQLLoader','ParseMaster','파싱에러 --> ' + stData  );
  end;
end;
