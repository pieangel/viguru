...
begin
  ...
  gEnv.EnvLog( WIN_TEST, Format('%s 조회 %s : %s', [ stPrx, ifThenStr( Result,'성공','실패'),
...
begin
  ...
  begin
    gEnv.EnvLog( WIN_ERR, '잔고 조회 실패 - 계좌 이상' );
    Exit;
  end;
