...
begin
  ...
  try
    ...
    aQuote.Last := StrToFloat( trim(string( vData.price )));
    aQuote.Change := StrToFloat( trim(string( vData.change )));
          {
    case vData.sign of
    ...
    aQuote.Symbol.RealUpperLimit  := StrToFloat( trim( string( vData.real_hprice )));
    aQuote.Symbol.RealLowerLimit  := StrToFloat( trim( string( vData.real_lprice )));
