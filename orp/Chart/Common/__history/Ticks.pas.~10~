...
begin
  ...
  FtrQ.PushItem( aItem.StartTime, r);

  //FATR2 := FATR2 + (r- FtrQ.FirstData ) / FtrQ.MaxCount;
  LastTerm.ATR  := FtrQ.SumPrice / FtrQ.MaxCount;
  //FATR + (r - FATR)/FParam.Period;
