...
type
  ...
  public
    ...
    property Param : TStrangleParams read FParam;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if aQuote.Bids.CntTotal * FParam.UpBid[i] > aQuote.Asks.CntTotal then
          inc(iMultiple)
        else
          break;
      end;
    ...
    begin
      for  i := iIndex to 2 do
      begin
        if  aQuote.Asks.CntTotal * FParam.DownBid[i] > aQuote.Bids.CntTotal then
          inc(iMultiple)
        else
          break;
      end;
