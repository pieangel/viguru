...
uses Classes, SysUtils, Windows, Dialogs,
  ...
  CleQuoteBroker, CleSymbols, CleQuoteParserIF,
    // Lemon: utilities
  CleParsers,  GleConsts,  UUdpPacketpv2,
...
type
  TQuoteParserPv2 = class( TIFQuoteParser )
  private
      // parse
...
constructor TQuoteParserPv2.Create;
begin
  inherited;
end;

destructor TQuoteParserPv2.Destroy;
begin
  inherited;
end;

procedure TQuoteParserPv2.Parse(stData: String);
var
...
procedure TQuoteParserPv2.ParseCPPPIIndex(stData: string);
var
...
procedure TQuoteParserPv2.ParseElwGreeks(stData: string);
var
  vData : PElwGreeks;
  stCode  : string;
  aQuote  : TQuote;
...
procedure TQuoteParserPv2.ParseFKOSPIIndex(stData: string);
var
  vData : PIndexData;
  stTime : string;
  aTime  : TDateTime;
...
procedure TQuoteParserPv2.ParseFutOpenInterset(stData: string);
var
...
procedure TQuoteParserPv2.ParseInvestorData(stData: string);
var
  stLog, stID, stCP : string;
  vData : PInvestorData;
  aItem : TInvestorData;
begin
  if Length( stData ) < LenInvestorData then
    Exit;
  vData := PInvestorData( stData );
  stID := string(vData.InvestType);
  stCP := string(vData.cCP);
  aItem := gEnv.Engine.SymbolCore.ConsumerIndex.InvestorDatas.New(stID, stCP);

  if aItem = nil then exit;

  aItem.AskQty :=  StrToIntDef(string(vData.AskQty), 0);
  aItem.BidQty := StrToIntDef(string(vData.BidQty), 0);
  aItem.AskAmount := StrToFloatDef(string(vData.AskAmount), 0) / 100000000;
  aItem.BidAmount := StrToFloatDef(string(vData.BidAmount), 0) / 100000000;
  aItem.SumQty := aItem.BidQty - aItem.AskQty;
  aItem.SumAmount := aItem.BidAmount - aItem.AskAmount;
end;

procedure TQuoteParserPv2.ParseK200RiskIndex(stData: string);
var
  vData : PIndexData;
  stDiv, stTime : string;
  aTime  : TDateTime;
...
procedure TQuoteParserPv2.ParseKOSPI200FuturesMarketDepth(stData: String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : PFutPrice;
...
procedure TQuoteParserPv2.ParseKOSPI200FuturesTimeNSale(stData: String);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv2.ParseKOSPI200FuturesTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv2.ParseKOSPI200Index(stData: String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : pIndexData;
...
procedure TQuoteParserPv2.ParseKOSPI200IndexExpect(stData: String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
...
procedure TQuoteParserPv2.ParseKOSPI200OptionMarketDepth(stData: String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : POptPrice;
...
procedure TQuoteParserPv2.ParseKOSPI200OptionsTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv2.ParseKOSPI200OptionTimeNSale(stData: String);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
  stCode, stTime : string;
...
procedure TQuoteParserPv2.ParseKOSPI200StockFuturesTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv2.ParseKospiStockVolumeTotal(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv2.ParseKRXELWMarketDepth(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv2.ParseKRXStockMarketDepth(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv2.ParseKRXStockTimeNSale(stData: string);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv2.ParseOptOpenInterset(stData: string);
var
...
procedure TQuoteParserPv2.ParseOptRecovery(stData: string);
var
...
procedure TQuoteParserPv2.Parser(pData: PChar; iSize: Integer);
var
  pComm : PCommonHeader;
begin
  Inc(FParseCount);
...
procedure TQuoteParserPv2.ParserOptionGreeks(stData: string);
var
  vData : POptionGreeks;
  aSymbol :  TOption;
begin
...
procedure TQuoteParserPv2.ParseStockFuturesMarketDepth(stData: string);
var
  aQuote : TQuote;
  i : integer;
  dtQuote : TDateTime;
...
procedure TQuoteParserPv2.ParseStockFuturesTimeNSale(stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
  vData : PStockFutTick;
...
procedure TQuoteParserPv2.ParseVKOSPIIndex(stData: string);
var
  vData : PIndexData;
  stTime : string;
  aTime  : TDateTime;
