...
type
  TQuoteParserPv1 = class( TIFQuoteParser )
  private
      // parse
...
constructor TQuoteParserPv1.Create;
begin
  inherited;
end;

destructor TQuoteParserPv1.Destroy;
begin
  inherited;
end;
...
procedure TQuoteParserPv1.Parser(pData: PChar; iSize : Integer);
var
...
procedure TQuoteParserPv1.Parse(stData : String);
var
  stTR, stInfo, stSave, stUdp : String;
  pComm : PCommonHeader;
begin
...
procedure TQuoteParserPv1.ParseCPPPIIndex(stData: string);
var
...
procedure TQuoteParserPv1.ParserOptionGreeks(stData : string);
var
  vData : POptionGreeks;
  aSymbol :  TOption;
begin
...
procedure TQuoteParserPv1.ParseElwGreeks(stData: string);
var
  vData : PElwGreeks;
  stCode  : string;
  aQuote  : TQuote;
...
procedure TQuoteParserPv1.ParseFKOSPIIndex(stData: string);
var
  vData : PIndexData;
  stTime : string;
  aTime  : TDateTime;
...
procedure TQuoteParserPv1.ParseFutOpenInterset(stData: string);
var
...
procedure TQuoteParserPv1.ParseInvestorData(stData: string);
var
...
procedure TQuoteParserPv1.ParseOptOpenInterset(stData: string);
var
...
procedure TQuoteParserPv1.ParseOptRecovery(stData: string);
var
...
procedure TQuoteParserPv1.ParseKOSPI200Index(stData : String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : pIndexData;
...
procedure TQuoteParserPv1.ParseKOSPI200IndexExpect(stData: String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
...
procedure TQuoteParserPv1.ParseK200RiskIndex(stData: string);
var
  vData : PIndexData;
  stDiv, stTime : string;
  aTime  : TDateTime;
...
procedure TQuoteParserPv1.ParseKOSPI200FuturesMarketDepth(stData : String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : PFutPrice;
...
procedure TQuoteParserPv1.ParseKOSPI200FuturesTimeNSale(stData : String);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
  stCode, stTime : string;
...
procedure TQuoteParserPv1.ParseKOSPI200FuturesTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv1.ParseKOSPI200OptionMarketDepth(stData : String);
var
  aQuote: TQuote;
  dtQuote: TDateTime;
  vData : POptPrice;
...
procedure TQuoteParserPv1.ParseKOSPI200OptionsTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
procedure TQuoteParserPv1.ParseKOSPI200OptionTimeNSale(stData : String);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
  stCode, stTime : string;
...
procedure TQuoteParserPv1.ParseKOSPI200StockFuturesTimeNSaleNMarketDepth(
  stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
...
// H1/h1
procedure TQuoteParserPv1.ParseKRXStockMarketDepth(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv1.ParseKRXStockTimeNSale(stData: string);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv1.ParseStockFuturesMarketDepth(stData: string);
var
  aQuote : TQuote;
  i : integer;
  dtQuote : TDateTime;
...
procedure TQuoteParserPv1.ParseStockFuturesTimeNSale(stData: string);
var
  aQuote: TQuote;
  aSale: TTimeNSale;
  vData : PStockFutTick;
...
procedure TQuoteParserPv1.ParseVKOSPIIndex(stData: string);
var
  vData : PIndexData;
  stTime : string;
  aTime  : TDateTime;
...
// h3
procedure TQuoteParserPv1.ParseKRXELWMarketDepth(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
...
procedure TQuoteParserPv1.ParseKospiStockVolumeTotal(stData: String);
var
  aQuote : TQuote;
  dtQuote : TDateTime;
  i : Integer;
