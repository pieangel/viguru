object KRXQuoteEmulationForm: TKRXQuoteEmulationForm
  Left = 178
  Top = 103
  Caption = 'KRX Quote Emulation'
  ClientHeight = 247
  ClientWidth = 562
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DateTimePickerDate: TDateTimePicker
      ...
      Width = 88
      Height = 21
      Date = 39438.651344537040000000
      Time = 39438.651344537040000000
      ImeName = 'Korean Input System (IME 2000)'
      TabOrder = 0
    end
    ...
    object cbFillEnabled: TCheckBox
      Left = 280
      Top = 7
      Width = 97
      Height = 17
      Caption = 'Linked IO Data'
      TabOrder = 3
      OnClick = cbFillEnabledClick
    end
    object cbUseS5: TCheckBox
      Left = 395
      Top = 7
      Width = 62
      Height = 17
  ...
  object GroupBox1: TGroupBox
    ...
    object EditTargetHost: TEdit
      ...
      ImeName = 'Korean Input System (IME 2000)'
      TabOrder = 0
      Text = '192.168.201.218'
      OnKeyPress = EditSpeedKeyPress
    end
    object EditQuotePort: TEdit
      Left = 70
      Top = 47
      Width = 49
      Height = 21
  ...
  object gbAccount: TGroupBox
    ...
    object spbSuspend: TSpeedButton
      Left = 111
      Top = 160
      Width = 50
      Height = 20
    ...
    object cbOnlyMaster: TCheckBox
      Left = 6
      Top = 91
      Width = 137
      Height = 17
      Caption = #47560#49828#53552#54028#51068#47564' '#51069#44592
      TabOrder = 4
    end
  ...
  object ButtonTick: TBitBtn
    ...
    Caption = 'Tick'
    TabOrder = 15
    OnClick = ButtonTickClick
  end
  object PlayTimer: TTimer
    Enabled = False
    Interval = 1
    OnTimer = PlayTimerProc
    Left = 326
    Top = 82
  end
  object IdUDPClientQuote: TIdUDPClient
    Port = 0
    Left = 219
    Top = 123
  end
  object LoadTimer: TTimer
    Enabled = False
    OnTimer = LoadTimerProc
    Left = 352
    Top = 80
  end
  object IdUDPClientFill: TIdUDPClient
    Port = 0
    Left = 283
    Top = 99
  end
