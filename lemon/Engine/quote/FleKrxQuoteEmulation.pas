      ...
      begin
        ...
        begin
          ...
          if (CompareStr(stTR, 'A3') = 0)      // Fill
              ...
              or (CompareStr(stTR, 'H1') = 0)  // 투자자테이터
              or (CompareStr(stTR, 'V1') = 0)  // 가격제한폭변동
          then
          begin
...
begin
  ...
  case tsType of
    ...
    tsEnd:
      begin
        // 시세 파일 다 돌았으면..각 화면 로깅을 위해 300 을 전달해준다.
