...
begin
  if Assigned(FOnLog) then
    FOnLog(stLog);
  gEnv.EnvLog( WIN_MC, 'StccBroker : ' + stLog );
end;
...
전략과 실제 계좌 종목 연결.
FLinks - TSignalLinkItem  //

링크를 통해 타켓을 만든다 ( 계좌, 종목 ) = 포지션 !!
