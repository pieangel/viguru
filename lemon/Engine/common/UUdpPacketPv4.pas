...
const
  ...
  K200FutMat = 'A0014';
  K200OptMat = 'A0034';
  MiniK200FutMat = 'A0124';
  MiniK200OptMat = 'A0134';
  CommodityMat = 'A0016';
...
type
  ...
  CmdFutPriceQtyItem = packed record
    Sign  : char;
    Price : array [0..7] of char;
    Volume: array [0..5] of char;
  end;
...
{$REGION '상품선물 '}
  ...
  PCmdFutPrice = ^TCmdFutPrice;
  TCmdFutPrice = packed record
    Code  : array [0..11] of char;
    ...
    //
    BidTotVol  : array [0..5] of char;
    BidItems   : array [0..4] of CmdFutPriceQtyItem;
    AskTotVol : array [0..5] of char;
    AskItems  : array [0..4] of CmdFutPriceQtyItem;
    //
    BidTotCnt  : array [0..4] of char;
    BidCntItems: DerCountItem;
    AskTotCnt : array [0..4] of char;
    ...
    AcptTime    : array [0..7] of char;
    ExpectSign  : char;                                 //2012.06.25 적용
    ExpectPrice  : array[0..7] of char;                 //2012.06.25 적용
  end;

  PCmdFutTick  = ^TCmdFutTick;
  TCmdFutTick  = packed record
    Code  : array [0..11] of char;
    Seq   : array [0..2]  of char;
    BoardID : array[0..1] of char;
    CurSign : char;
    CurPrice : array [0..7] of char;
    Volume  : array [0..5] of char;
    SessionID : array[0..1] of char;
    TickTime: array [0..7] of char;
    NearPrice : array [0..7] of char;
    FarPrice  : array [0..7] of char;
    //
    OpenSign  : char;
    ...
    PrevSign  : char;
    PrevPrice : array [0..8] of char;
    //
    DailyVolume : array [0..6] of char;
    DailyPrice  : array [0..14] of char;
    BlockDailyVolume : array [0..6] of char;
    EFPDailyVolume   : array [0..6] of char;
    LastLSCode : char;                // 1 : 매도   2 : 매수

    RealUpperLimitSign  : char;
    RealUpperLimit : array [0..7] of char;
    RealLowerLimitSign   : char;
    RealLowerLimit  : array [0..7] of char;
    EndText : char;
  end;

  PCmdFutTickPrice = ^TCmdFutTickPrice;
  TCmdFutTickPrice = packed record
    //Tick  : TFutTick;
    Code  : array [0..11] of char;
    Seq   : array [0..2]  of char;
    BoardID : array[0..1] of char;
    ...
    //
    OpenSign  : char;
    OpenPrice : array [0..7] of char;
    HighSign  : char;
    HighPrice : array [0..7] of char;
    LowSign   : char;
    LowPrice  : array [0..7] of char;
    PrevSign  : char;
    PrevPrice : array [0..7] of char;
    //
    DailyVolume : array [0..6] of char;
    DailyPrice  : array [0..14] of char;
    BlockDailyVolume : array [0..6] of char;
...
{$ENDREGION }
  ...
  ////// 2015.06.15 부터 적용될 가격제한폭확대발동
  PFutPriceLimit = ^TFutPriceLimit;
  TFutPriceLimit = packed record
    code  : array [0..11] of char;
    Seq   : array [0..1] of char;
    ProductID : array [0..10] of char;
    BoardID   : array [0..1] of char;
    PriceExTime : array [0..7] of char;
    PriceExUpLv : array [0..1] of char;
    PriceExDownLv : array [0..1] of char;

    signhigh : char;                                         //Sign 부호
    highlimit : array[0..4] of char;                        //상한가
    signlow : char;                                          //Sign 부호
    lowlimit : array[0..4] of char;                         //하한가     
    filler  : char;
  end;

  POptPriceLimit = ^TOptPriceLimit;
  TOptPriceLimit = packed record
    code  : array [0..11] of char;
    Seq   : array [0..2] of char;
    ProductID : array [0..10] of char;
    BoardID   : array [0..1] of char;
  ...
  ////////////////////////////파생마스터///////////////////////////////////
  PDerMasterpv4 = ^TDerMasterpv4;
  TDerMasterpv4 =  record
     datatype : array[0..4] of char;                          //데이터구분 A0015 : 주식선물, A0014 : 지수선물, A0034 : 지수옵션,  A0124 : 미니선물
     ...
     // 2015.05.08 - 2015.06.15 에 적용 예정
     pricelimitcode : char;                                   // 가격제한확대적용방향코드
     pricelimitlv   : array [0..2] of char;                   // 가격제한최종단계 X :미적용 F : 정방향  B:역방향 , T : 양방향
     highlowlimit : array [0..2] of THighLowLimit;
     ////////////
     ...
     underlyingID : array [0..2] of char;
...
const
  ...
  LenCmdFutPrice = sizeof( TCmdFutPrice );
  LenCmdFutTick  = sizeof( TCmdFutTick );
  LenCmdFutTickPrice = sizeof( TCmdFutTickPrice );
  ...
  LenDerMasterpv4  = sizeof( TDerMasterpv4 );
